	...
	export default {
		...
		methods:{
			...
			formSubmit: function(e) {
				...
				if(!title || !content || !addPoints || !personNum){
					uni.showModal({
						content:"请输入必填项",
						showCancel:false
					});
				...
				console.log('表单提交数据:','addPoints:',addPoints,that.allPoints,',title:',title,',typeId:',typeId,',deptId:',that.checkedDeptIds,',postId',that.checkedRoleIds,',人数:',personNum)
